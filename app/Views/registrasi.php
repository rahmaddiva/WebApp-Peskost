        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body col-12">
              ...
              <!-- /Logo -->
              <p class="mb-4">Silakan isi formulir di bawah ini untuk mendaftar.</p>

             <form id="formAuthentication" class="mb-3" action="<?= base_url('registrasi/proses_registrasi') ?>" method="POST">
              <div class="row">
                <!-- Username -->
                    <!-- Email -->
